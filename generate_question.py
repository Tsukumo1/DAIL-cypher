...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_type", type=str, choices=["neo4j", "realistic", "bird"], default="neo4j")
    ...
    parser.add_argument("--prompt_repr", type=str, choices=[REPR_TYPE.CODE_REPRESENTATION,
                                                            ...
                                                            REPR_TYPE.CBR])
    parser.add_argument("--example_type", type=str, choices=[EXAMPLE_TYPE.ONLY_Cypher, 
                                                             EXAMPLE_TYPE.QA, 

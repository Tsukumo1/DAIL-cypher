...
def get_example_format_cls(example_format: str):
    if example_format == EXAMPLE_TYPE.ONLY_Cypher:
        example_format_cls = CypherExampleStyle
    elif example_format == EXAMPLE_TYPE.QA:
        example_format_cls = QuestionCypherExampleStyle
    elif example_format == EXAMPLE_TYPE.QAWRULE:
        example_format_cls = QuestionCypherWithRuleExampleStyle
        ...
        example_format_cls = NumberSignQuestionCypherExampleStyle
    elif example_format == EXAMPLE_TYPE.BASIC_QA:
        example_format_cls = BaselineQuestionCypherExampleStyle
    else:

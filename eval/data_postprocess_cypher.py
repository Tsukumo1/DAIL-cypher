...
def extract_cypher_queries_asfile(input_file, output_file):
    content=[]
    ...
    print(f"Extracted {len(cypher_queries)} unique cypher queries to {output_file}")

# Usage
input_file = 'Replace with your input file name' 
output_file = 'Replace with your desired output file name'  

extract_cypher_queries_asfile(input_file, output_file)

class REPR_TYPE:
    ...
    CODE_REPRESENTATION_WRULE = "CypherWRULE"
    ALPACA_SFT_WRULE = "INSTRUCTIONWRULE"
    TEXT_REPRESENTATION_WRULE = "TEXTWRULE"
    CODE_REPRESENTATION_COT = "CypherCOT"
...
class LLM:
    ...
    GPT_4 = "gpt-4"
    TONG_YI_QIAN_WEN = "qwen-1.8b-chat"
    LLAMA_3_8B = "llama3-70b-instruct"
    LLAMA_2_13B = "llama2-13b-chat-v2"

    
    QWEN_2_7B = 'qwen-2-7B'
    QWEN_PLUS = 'qwen-plus'
    META_LLAMA_3_8B = "Llama-3.1-8B-Instruct"
    DEEP_SEEK = "deepseek_coder_v2"
